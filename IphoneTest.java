...
public class IphoneTest {
	...
	public static void main(String[] args) {
		...
		Iphone iphone13Mini = new Iphone(13, "mini", "white", 128, LocalDate.parse("2021-01-01").getYear());
		Iphone iphone12Max = new Iphone(12, "max", "white", 128, LocalDate.parse("2020-01-01").getYear());
		Iphone iphone13Max = new Iphone(13, "max", "white", 128, LocalDate.parse("2021-01-01").getYear());
		
		
		iphone13Mini.setColor("black");
